    ...
    <div class="login">
      <div class="login__content">
        ...
        <div class="login__images">
          <img
            src="@/assets/images/statics/lines/path5.svg"
            alt=""
        ...
        <div class="input__group">
          ...
          <div class="input__group-item">
            <label for="password" class="input__group-password">Подтверждение</label>
            <input
              type="password"
              id="password"
              v-model="password"
          ...
          <div class="login__botton">
            <button class="login__botton-btn" @click="login">Далее</button>
          </div>
          ...
          <div class="login__register">
            <p class="login__register-link">
                Уже есть аккаунт? <span class="login__register-reg"><a href="#">Войдите в него.</a></span>
            </p>
